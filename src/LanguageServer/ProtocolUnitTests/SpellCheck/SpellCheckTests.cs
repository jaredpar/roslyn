...
@"class A {";
            ...
            var csharpDocumentPath = TestPathUtil.GetRootedPath("C.cs");
            var typeScriptDocumentPath = TestPathUtil.GetRootedPath("T.ts");

            var workspaceXml =
                $"""
                <Workspace>
                            <Project Language="C#" CommonReferences="true" AssemblyName="CSProj1">
                                <Document FilePath="{csharpDocumentPath}">{csharpMarkup}</Document>
                            </Project>
                            <Project Language="TypeScript" CommonReferences="true" AssemblyName="TypeScriptProj">
                                <Document FilePath="{typeScriptDocumentPath}">{typeScriptMarkup}</Document>
                            </Project>
                        </Workspace>
                """;
            ...
            Assert.True(results.All(r => r.TextDocument!.DocumentUri.GetRequiredParsedUri().LocalPath == csharpDocumentPath));
        }
