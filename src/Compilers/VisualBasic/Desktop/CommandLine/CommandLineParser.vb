...
lVbRuntimePlus:
            ...
            Dim defaultCoreLibraryReference As CommandLineReference? = LoadCoreLibraryReference(sdkDirectory, sdkPaths, baseDirectory)
            ...
            If Not noStdLib Then
                Dim systemDllPath As String = FindFileInSdkPath(sdkDirectory, sdkPaths, "System.dll", baseDirectory)
            ...
            If includeVbRuntimeReference Then
                If vbRuntimePath Is Nothing Then
                    Dim msVbDllPath As String = FindFileInSdkPath(sdkDirectory, sdkPaths, "Microsoft.VisualBasic.dll", baseDirectory)
        ...
        Private Function LoadCoreLibraryReference(sdkDirectory As String, sdkPaths As List(Of String), baseDirectory As String) As CommandLineReference?
            ...
            ' mscorlib. 
            Dim msCorLibPath As String = FindFileInSdkPath(sdkDirectory, sdkPaths, "mscorlib.dll", baseDirectory)
            Dim systemRuntimePath As String = FindFileInSdkPath(sdkDirectory, sdkPaths, "System.Runtime.dll", baseDirectory)
        ...
        Private Function FindFileInSdkPath(sdkPath As String, sdkPaths As List(Of String), fileName As String, baseDirectory As String) As String
            For Each path In sdkPaths
                Dim absolutePath = FileUtilities.ResolveRelativePath(If(path, sdkPath), baseDirectory)
