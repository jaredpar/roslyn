...
Namespace Microsoft.CodeAnalysis.VisualBasic.UnitTests.Semantics
    ...
    Partial Public Class DiagnosticAnalyzerTests
        ...
        Public Class ComplainAboutX
            ...
            Private Shared ReadOnly s_CA9999_UseOfVariableThatStartsWithX As DiagnosticDescriptor = New DiagnosticDescriptor(id:="CA9999", title:="CA9999_UseOfVariableThatStartsWithX", messageFormat:="Use of variable whose name starts with 'x': '{0}'", category:="Test", defaultSeverity:=DiagnosticSeverity.Warning, isEnabledByDefault:=True)
...
End Namespace
        ...
        Private Class CodeBlockAnalyzer
            ...
            Private Shared s_descriptor As DiagnosticDescriptor = New TriggerDiagnosticDescriptor("CodeBlockDiagnostic")
