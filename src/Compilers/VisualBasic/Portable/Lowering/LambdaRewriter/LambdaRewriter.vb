...
#End If
        ...
        Private Function GetFrameForScope(copyConstructor As Boolean,
            ...
            If Not _frames.TryGetValue(node, frame) Then
        ...
        Private Function GetStaticFrame(lambda As BoundNode, diagnostics As DiagnosticBag) As LambdaFrame
            If Me._lazyStaticLambdaFrame Is Nothing Then
                ...
                If Me._lazyStaticLambdaFrame Is Nothing Then
                    ...
                    Me._lazyStaticLambdaFrame = New LambdaFrame(SlotAllocatorOpt, CompilationState, _topLevelMethod, If(isNonGeneric, -1, _topLevelMethodOrdinal), lambda.Syntax, scopeOrdinal:=-1, copyConstructor:=False, isStatic:=True, isDelegateRelaxationFrame:=False)
