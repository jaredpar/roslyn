...
";
        ...
        {
            var binaryPath = Temp.CreateFile().WriteAllBytes(ResourcesNet451.mscorlib.ImageBytes).Path;
...
Copyright (C) Microsoft Corporation. All rights reserved.", output);
        ...
        public void IOFailure_DisposeOutputFile()
        {
            ...
            csc.FileSystem = TestableFileSystem.CreateForOpenFile((file, mode, access, share) =>
            {
                if (file == exePath)
                {
