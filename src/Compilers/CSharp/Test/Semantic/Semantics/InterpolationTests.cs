...
class Program {
    ...
    public static async Task M(Task<string> hello, Task<string> world)
    {
        Console.WriteLine($""{ await hello }, { await world }!"");
            ...
            CompileAndVerify(
                source, references: new[] { MscorlibRef_v4_0_30316_17626, SystemRef_v4_0_30319_17929, TestMetadata.Net451.SystemCore }, expectedOutput: "Hello, world!", targetFramework: TargetFramework.Empty);
        }
