...
";
            ...
            var comp = CreateEmptyCompilation(source, new[] { MscorlibRef, Net451.SystemCore, ilRef });
            comp.VerifyDiagnostics();
...
";
            var ilRef = CompileIL(il, prependDefaultHeader: false);
            var comp1 = CreateEmptyCompilation(source1, new[] { MscorlibRef, Net451.SystemCore, ilRef, ValueTupleRef, SystemRuntimeFacadeRef, CSharpRef });
...
";
            var comp2 = CreateEmptyCompilation(source2, new[] { MscorlibRef, Net451.SystemCore, ilRef, ValueTupleRef, SystemRuntimeFacadeRef, CSharpRef });
...
";
            var comp3 = CreateEmptyCompilation(source3, new[] { MscorlibRef, Net451.SystemCore, ilRef, ValueTupleRef, SystemRuntimeFacadeRef, CSharpRef });
...
";
            var comp4 = CreateEmptyCompilation(source4, new[] { MscorlibRef, Net451.SystemCore, ilRef, ValueTupleRef, SystemRuntimeFacadeRef, CSharpRef });
