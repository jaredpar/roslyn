...
namespace Microsoft.CodeAnalysis.CSharp
{
    partial class Binder
    {
        ...
        {
            var success = BindLengthAndIndexerForListPattern(node, inputType, inputValEscape: CallingMethod, BindingDiagnosticBag.Discarded,
        ...
        /// result is either that same scope (if the type is a ref struct type) or <see cref="Binder.CallingMethod"/>.
        /// </summary>
        private static uint GetValEscape(TypeSymbol type, uint possibleValEscape)
        {
            return type.IsRefLikeType ? possibleValEscape : Binder.CallingMethod;
        }
            ...
            BindingDiagnosticBag diagnostics)
        {
            ...
            const uint valEscape = Binder.CallingMethod;
