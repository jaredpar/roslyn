...
public sealed class FilePathUtilitiesTests
{
    ...
    public void GetRelativePath_SameDirectory()
    {
        ...
        var fullPath = Path.Combine(baseDirectory, "Doc.txt");
    ...
    {
        var baseDirectory = TestPathUtil.GetRootedPath("Alpha", "Beta", "Gamma");
        var fullPath = Path.Combine(baseDirectory, "Delta", "Doc.txt");
    ...
    {
        var baseDirectory = TestPathUtil.GetRootedPath("Alpha", "Beta", "Gamma");
        var fullPath = Path.Combine(baseDirectory, "Delta", "Epsilon", "Doc.txt");
    ...
    [ConditionalFact(typeof(WindowsOnly), Reason = "Only Windows has distinct drive roots."), WorkItem("https://github.com/dotnet/roslyn/issues/1579")]
